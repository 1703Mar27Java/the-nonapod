...
<body>
	...
	<script type="text/javascript" src="<c:url value="/resources/scripts/build.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/scripts/html2canvas.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/scripts/FileSaver.min.js" />"></script>
...
<nav  class="navbar navbar-inverse">
	...
	<div class="build">
		...
		<div class="build-view">
			...
			<div id="palet">
				<img id="drag1" class="palet-item north" src="${blackSquare}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag3" class="palet-item north" src="${blueSquare}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag5" class="palet-item north" src="${graySquare}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag7" class="palet-item north" src="${greenSquare}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag9" class="palet-item north" src="${magentaSquare}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag11" class="palet-item north" src="${orangeSquare}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag13" class="palet-item north" src="${pinkSquare}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag15" class="palet-item north" src="${redSquare}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag17" class="palet-item north" src="${white}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag19" class="palet-item north" src="${yellowSquare}" draggable="true" ondragstart="drag(event)" width="30" height="30"><br>
				<img id="drag2" class="palet-item north" src="${blackTri}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag4" class="palet-item north" src="${blueTri}" draggable="true" ondragstart="drag(event)" width="30" height="30">			
				<img id="drag6" class="palet-item north" src="${grayTri}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag8" class="palet-item north" src="${greenTri}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag10" class="palet-item north" src="${mengentaTri}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag12" class="palet-item north" src="${orangeTri}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag14" class="palet-item north" src="${pinkTri}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag16" class="palet-item north" src="${redTri}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag18" class="palet-item north" src="${whiteTri}" draggable="true" ondragstart="drag(event)" width="30" height="30">
				<img id="drag20" class="palet-item north" src="${yellowTri}" draggable="true" ondragstart="drag(event)" width="30" height="30">
